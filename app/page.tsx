...
import { ChevronDown, FileText, Shield, Zap, Clock, CheckCircle, Star, ArrowRight, Building2, Users, Globe } from "lucide-react";
...
const forms = [
  ...
  { value: "notice-of-directors", label: "Notice of Directors" },
  { value: "annual-return", label: "Annual Return" },
  { value: "sred-tax-claim", label: "SR&ED Tax Claim" },
  { value: "shareholder-agreement", label: "Shareholder Agreement" },
  { value: "trademark-application", label: "Trademark Application" },
...
export default function HomePage() {
  ...
  function handleStartFiling() {
    if (!selectedRegion || !selectedForm) {
      setError("Please select both a province and a document type.");
      return;
    }
    setError("");
    router.push(`/${selectedRegion}/${selectedForm}`);
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl text-slate-600 leading-relaxed animate-fade-in-up animate-delay-200">
              Stop overpaying lawyers for standard filings. Select your province, pick your document, and receive a court-ready PDF in minutes — for a flat <strong className="text-slate-900">$49</strong>.
            </p>

            {/* Search Widget */}
            <div className="mt-10 bg-white rounded-2xl shadow-xl border border-slate-100 p-6 sm:p-8 animate-fade-in-up animate-delay-300">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none bg-slate-50 border border-slate-200 text-slate-900 font-medium rounded-xl px-4 py-3.5 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all cursor-pointer"
                    >
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-bold py-4 rounded-xl shadow-lg transition-all text-lg flex items-center justify-center gap-2 pulse-btn group"
              >
                Start Filing — $49 flat fee
            ...
            {[
              {
                ...
                desc: "Choose your province and document type from our database of 56 form combinations.",
      ...
      <section className="py-16 bg-blue-50 border-y border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-3">
            Browse all 56 form combinations
          </h2>
          <p className="text-slate-600 mb-6">
            8 document types across 7 Canadian provinces and federal jurisdiction.
          </p>
          <a
            href="/directory"
